        ...
        init:
          function(e){
            ...
            t.data[a]={
              ...
              actions:function(i,t,a,n,r){return e.renderFileActions(i,t,a,n,r)}
            }
          },

          fetch:
            function(e){
              return t.data[e].content.filter(function(e){return null!==e})
              },
          ...
          get:
            function(e,i,a){
               ...
               l.content[i]).repl("{footer}",
               t.footer(e,i,a)),
               l.tags.length&&l.tags[i]&&(n=_(n,l.tags[i])),n)
               },
          ...
          add:
            function(i,a,n,r,l){
              ...
              l?(o=s.content.push(a)-1,s.config[o]=n,s.tags[o]=r):(o=a.length,s.content=a,s.config=n,s.tags=r),
              t.data[i]=s,o},
          ...
          unset:
            function(e,i){
              ...
              if(a){
                ...
                if(1===a) return t.data[e].content=[],
